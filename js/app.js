...
const student = [
    ...
    ['Iqbal Hossain', 5, 10, 5, 'Male', 'Karwan Bazar', 5000],
    ['Sujon Shil', 6, 14, 3, 'Male', 'Karwan Bazar', 3000],
    ['Bristy Roy', 7, 12, 3, 'Female', 'Badda', 3000],
    ['Musabbir Rahman', 8, 35, 5, 'Male', 'Bashabo', 5000],
    ['Arifa Akhter', 9, 28, 5, 'Female', 'Farmgate', 5000],
    ['Zakaria Khan', 10, 30, 5, 'Male', 'Bashudhora', 5000],
    ['Animesh Benarje', 11, 34, 3, 'Male', 'Old Dhaka', 3000],
    ...
    ['Muyeen Hossain', 19, 14, 3, 'Male', 'Karwan Bazar', 3000],
    ['Shafiq Islam', 20, 12, 4, 'Male', 'Karwan Bazar', 4000],
    ['Shariar Kobir', 21, 14, 3, 'Male', 'Banglamotor', 3000],
...
student.forEach( item => {
    ...
    // if(item[3] == 3){
    //     console.log(`${ item[0] } read in Class 3`);
    // }
    //  else if(item[3] == 4){
    //     console.log(`${ item[0] } read in Class 4`);
    // }else{
    //     console.log(`${ item[0] } read in Class 5`);
    // }
